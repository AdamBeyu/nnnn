...
# Konfiguration
DIFFICULTY = 11 # Anzahl der führenden Nullen im Hex-Hash (z. J. 11 = 0000000000...)
LOTTERY_DURATION = 60  # Sekunden, wie lange die Lotterie läuft
WALLET_ADDRESS = "1ArBbCTicZy8DSgi4oJ9zUvbtsD3bY6mjz" # sent to wallet address (simulated)
